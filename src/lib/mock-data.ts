  ...
  "u1-l1": {
    ...
    exercises: [
      ...
      ),
      {
        ...
        hint: "The classic farewell: two syllables, starts with a-. A ‘see you later’ phrase is accepted too.",
  ...
  "u1-l2": {
    ...
    exercises: [
      ...
      ),
      {
        ...
        hint: "Spanish says ‘I call myself…’: the ‘myself’ pronoun, then llamarse in its yo form, then the name.",
  ...
  "u1-l3": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "Two words: a preposition + a cognate of ‘favor’ — literally ‘as a favor’. A casual one-word version is accepted too.",
  ...
  "u1-l4": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "Literally ‘How do you call yourself?’ — the ‘how’ question word, then the ‘yourself’ pronoun and the tú form of llamarse.",
      ...
      },
      {
        ...
        hint: "The classic reply to gracias is two words meaning ‘of nothing’; ‘with pleasure’ is accepted too.",
  ...
  "u2-l1": {
    ...
    exercises: [
      ...
      teach("teach-u2l1-de-donde-eres", "de-donde-eres"),
      {
        ...
        hint: "Literally ‘From where are you?’: the origin preposition, the ‘where’ question word, then the tú form of ser.",
      ...
      },
      {
        ...
        hint: "The yo form of vivir + the ‘in’ preposition + the country (capital M, accent on the e). No subject pronoun needed.",
      ...
      },
      {
        ...
        hint: "Origin uses ser, not estar — you need its yo form.",
  ...
  "u2-l2": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "There’s no ‘do’ in Spanish: just the tú form of hablar + the language name (lowercase, with an accent).",
      ...
      },
      {
        ...
        hint: "Hablar in the yo form, then the ‘a little (of)’ phrase — three short words — then the language, with its ñ.",
  ...
  "u2-l3": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "Origin is ser in the yo form + the origin preposition + the country (two capitalized words, no article). The nationality adjective works too.",
      ...
      ),
      {
        ...
        hint: "The yo form of vivir + the ‘in’ preposition + the country name — two words, both capitalized, no article.",
  ...
  "u3-l1": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "Querer in the yo form + the masculine article + the drink, then the politeness phrase after a comma.",
  ...
  "u3-l2": {
    ...
    exercises: [
      ...
      teach("teach-u3l2-veinte", "veinte"),
      {
        ...
        hint: "Age uses tener, not ser: the yo form of tener + the number + the ‘years’ word.",
  ...
  "u3-l3": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "Several juices are the subject, so costar goes plural (ellos form): the ‘how much’ word + verb + the plural article + the LatAm juice word.",
