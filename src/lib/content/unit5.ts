...
export const UNIT5_LESSONS: Record<string, Lesson> = {
  "u5-l1": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "The yo form of querer + un + the LatAm juice word + de + the fruit (a cognate of ‘orange’).",
  ...
  "u5-l2": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "What you ask the server for at the end — the same word as a bank ‘account’.",
  ...
  "u5-l3": {
    ...
    exercises: [
      ...
      teach("teach-u5l3-pan", "pan"),
      {
        ...
        hint: "The yo form of querer + the bread word (no article), then the politeness phrase after a comma.",
      ...
      },
      {
        ...
        hint: "The grain served with chicken — a two-syllable word ending in -z.",
        explanation: "Quiero pollo con arroz.",
  ...
  "u5-l4": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "Querer in the yo form + the chicken word (a cognate of ‘poultry’), a comma, then the politeness phrase.",
      ...
      ),
      {
        ...
        pairs: [
          ...
          { left: "🥖", right: "el pan" },
          { left: "💧", right: "el agua" },
          { left: "🌮", right: "los tacos" },
        ],
        explanation: "Everyday food and drink.",
        wordCardIds: ["cafe", "leche", "pan", "agua", "tacos"],
        xp: 3,
      },
      {
        id: "u5l4-m2",
        ...
        pairs: [
          { left: "el jugo", right: "the juice" },
          { left: "la comida", right: "the food" },
          { left: "el almuerzo", right: "the lunch" },
          { left: "la cena", right: "the dinner" },
        ],
        explanation: "Meals and drinks.",
        wordCardIds: ["jugo", "comida", "almuerzo", "cena"],
        xp: 3,
      },
    ],
  },
  "u5-l5": {
    ...
    exercises: [
      ...
      ),
      {
        ...
        hint: "The formal ‘excuse me’, a comma, then me + the usted form of poder + the infinitive of traer + the water word.",
      ...
      },
      {
        ...
        hint: "The polite ‘would like’ form of gustar — the conditional, ending in -ía.",
  ...
  "u5-l6": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "What goes in a café con ___ — a cognate of ‘lactose’, feminine.",
        explanation: "Un café con leche, por favor.",
        wordCardIds: ["cafe", "leche"],
        xp: 3,
      },
  ...
  "u5-l7": {
    ...
    exercises: [
      ...
      ),
      {
        ...
        hint: "‘Let’s go’ is the nosotros form of ir + a, then un + a near-cognate of ‘restaurant’ (ends in -e).",
      ...
      },
      {
        ...
        hint: "What you leave the server — starts with p, feminine, three syllables.",
    ...
    exercises: [
      {
        ...
        hint: "The yo form of querer + un + the coffee word (accent on the é), then the politeness phrase.",
      ...
      ),
      {
        ...
        hint: "The LatAm word for a flat — a cognate of ‘department’.",
  ...
  "u5-l9": {
    ...
    description: "Listen to a café order story, answer, then fill in lines from it.",
    xpReward: 45,
    exercises: [
      storyListen(
        "u5l9-story",
      ...
      cloze(
        ...
        ["menu", "usted-server"],
        {
          hint: "What you ask the server to bring before ordering — a cognate, accent on the ú.",
      ...
      cloze(
        ...
        {
          hint: "The side that comes with the chicken in the story — ends in -z.",
      ...
      cloze(
        ...
        ["la-cuenta"],
        {
          hint: "The thing you ask for at the end of the meal — the same word as an ‘account’.",
  ...
  "u5-l10": {
    ...
    exercises: [
      ...
      ),
      {
        ...
        hint: "Para + a verb meaning ‘to carry / take away’ — the infinitive, ends in -ar.",
        explanation: "Para llevar, por favor.",
        wordCardIds: ["para-llevar"],
        xp: 3,
      },
      ...
      },
      {
        ...
        pairMode: "emoji-es",
        pairs: [
          { left: "🥗", right: "la comida" },
          { left: "🥪", right: "el almuerzo" },
          { left: "🌙", right: "la cena" },
          { left: "🧃", right: "el jugo" },
        ],
        explanation: "Meals through the day.",
        wordCardIds: ["comida", "almuerzo", "cena", "jugo"],
        xp: 3,
      },
      {
        id: "u5l10-m2",
        ...
        pairs: [
          ...
          { left: "la leche", right: "the milk" },
        ],
        explanation: "Ordering vocabulary.",
        wordCardIds: ["cafe", "pan", "leche"],
        xp: 3,
      },
    ],
  },
  "u5-l11": {
    ...
    exercises: [
      ...
      ),
      {
        ...
        acceptedAnswers: ["leche", "Leche"],
        hint: "Coffee with ___: the dairy word, a cognate of ‘lactose’.",
      ...
      cloze(
        ...
        ["cafe", "leche", "me-gusta"],
        {
          hint: "The dairy you add to coffee — a cognate of ‘lactose’, feminine.",
      ...
      cloze(
        ...
        ["te", "quiero"],
        {
          hint: "A hot drink that isn’t coffee — two letters, with an accent.",
      ...
      cloze(
        ...
        ["la-cuenta", "propina"],
        {
          hint: "What you leave after paying la cuenta — starts with p.",
  ...
  "u5-l12": {
    ...
    exercises: [
      ...
      ),
      {
        ...
        template: "Para ___, por favor.",
        acceptedAnswers: ["llevar", "Llevar"],
        hint: "Para + the infinitive for ‘to carry / take away’ — ends in -ar.",
        explanation: "Para llevar, por favor.",
        wordCardIds: ["para-llevar"],
        xp: 3,
      },
