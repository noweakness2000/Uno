...
export const UNIT11_LESSONS: Record<string, Lesson> = {
  ...
  "u11-l5": {
    ...
    exercises: [
      ...
      { id: "u11l5-2", type: "select", prompt: "‘My friends were at the party’ uses past (ongoing) estar:", options: ["Mis amigos estaban en la fiesta.", "Mis amigos fueron en la fiesta forever.", "Mis amigos estoy fiesta.", "Mis amigos iré fiesta."], correctIndex: 0, explanation: "Mis amigos estaban en la fiesta.", wordCardIds: ["estar-imperfect", "amigo", "fiesta"], xp: 3 },
  ...
  "u11-l12": {
    ...
    exercises: [
      ...
      { id: "u11l12-2", type: "select", prompt: "yo + ver past tense =", options: ["vi", "veía", "veo ayer", "veré"], correctIndex: 0, explanation: "vi.", wordCardIds: ["ver-preterite"], xp: 3 },
