...
export const UNIT11_LESSONS: Record<string, Lesson> = {
  "u11-l1": {
    ...
    exercises: [
      ...
      conjugate("u11l1-conj-1", "pasar", "yo", "Past tense", ["pasé", "pase", "Pasé"], "yo + pasar → pasé (as in pasé tiempo).", ["pasar-tiempo"], { hint: "pasé" }),
    ],
  },
  "u11-l2": {
    ...
    exercises: [
      ...
      { id: "u11l2-7", type: "translate", prompt: "Translate: ‘Do you know my friends?’", acceptedAnswers: ["¿Conoces a mis amigos?", "Conoces a mis amigos?", "¿Conoces a mis amigos"], hint: "Conoces a…", explanation: "¿Conoces a mis amigos?", wordCardIds: ["conocer", "amigo"], xp: 4 },
  ...
  "u11-l4": {
    ...
    exercises: [
      ...
      { id: "u11l4-7", type: "translate", prompt: "Translate: ‘Did you see my sister at the party?’", acceptedAnswers: ["¿Viste a mi hermana en la fiesta?", "Viste a mi hermana en la fiesta?", "¿Viste a mi hermana en la fiesta"], hint: "Viste a…", explanation: "¿Viste a mi hermana en la fiesta?", wordCardIds: ["ver-preterite", "hermano", "fiesta"], xp: 4 },
    ],
  },
  "u11-l5": {
  ...
  "u11-l6": {
    ...
    exercises: [
      ...
      conjugate("u11l6-2", "ver", "yo", "Past tense", ["vi", "Vi"], "yo + ver → vi.", ["ver-preterite"], { hint: "vi" }),
      conjugate("u11l6-3", "ver", "yo", "Past (ongoing)", ["veía", "veia", "Veía"], "yo + ver → veía.", ["ver-imperfect"], { hint: "veía" }),
      conjugate("u11l6-4", "estar", "nosotros/as", "Past (ongoing)", ["estábamos", "estabamos", "Estábamos"], "nosotros + estar → estábamos.", ["estar-imperfect"], { hint: "estábamos" }),
      conjugate("u11l6-5", "conocer", "yo", "Past tense", ["conocí", "conoci", "Conocí"], "yo + conocer → conocí.", ["conocer-preterite"], { hint: "conocí" }),
      conjugate("u11l6-6", "bailar", "tú", "Past tense", ["bailaste", "Bailaste"], "tú + bailar → bailaste.", ["bailar-preterite"], { hint: "bailaste" }),
      conjugate("u11l6-7", "invitar", "ellos/ustedes", "Past tense", ["invitaron", "Invitaron"], "ustedes/ellos + invitar → invitaron.", ["invitar-preterite"], { hint: "invitaron" }),
  ...
  "u11-l8": {
    ...
    exercises: [
      ...
      conjugate("u11l8-conj-1", "ver", "nosotros/as", "Past tense", ["vimos", "Vimos"], "nosotros + ver → vimos.", ["ver-preterite"], { hint: "vimos" }),
    ],
  },
  "u11-l9": {
  ...
  "u11-l11": {
    ...
    exercises: [
      ...
      conjugate("u11l11-conj-1", "ver", "tú", "Past tense", ["viste", "Viste"], "tú + ver → viste.", ["ver-preterite"], { hint: "viste" }),
    ],
  },
  "u11-l12": {
    ...
    exercises: [
      ...
      conjugate("u11l12-conj-1", "conocer", "yo", "Past tense", ["conocí", "conoci", "Conocí"], "yo + conocer → conocí.", ["conocer-preterite"], { hint: "conocí" }),
      conjugate("u11l12-conj-2", "estar", "yo", "Past (ongoing)", ["estaba", "Estaba"], "yo + estar → estaba.", ["estar-imperfect"], { hint: "estaba" }),
