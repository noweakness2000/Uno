...
export const UNIT9_LESSONS: Record<string, Lesson> = {
  ...
  "u9-l6": {
    ...
    exercises: [
      ...
      { id: "u9l6-9", type: "fill-blank", prompt: "Type the missing Spanish.", englishPrompt: "You (tú) used to have a passport.", template: "Tú ___ un pasaporte.", acceptedAnswers: ["tenías", "tenias", "Tenías"], hint: "tener past (ongoing)", explanation: "Tú tenías un pasaporte.", wordCardIds: ["tener-imperfect", "pasaporte"], xp: 3 },
