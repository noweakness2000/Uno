...
export const UNIT9_LESSONS: Record<string, Lesson> = {
  ...
  "u9-l3": {
    ...
    exercises: [
      ...
      { id: "u9l3-7", type: "translate", prompt: "Translate: ‘What do you think of the hotel?’", acceptedAnswers: ["¿Qué opinas del hotel?", "¿Qué piensas del hotel?", "Qué opinas del hotel?"], hint: "¿Qué opinas…?", explanation: "¿Qué opinas del hotel?", wordCardIds: ["que-opinas", "hotel"], xp: 4 },
