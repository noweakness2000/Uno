...
export const UNIT9_LESSONS: Record<string, Lesson> = {
  ...
  "u9-l5": {
    ...
    exercises: [
      ...
      conjugate("u9l5-conj-1", "hablar", "yo", "Past (ongoing)", ["hablaba", "Hablaba"], "yo + hablar → hablaba.", ["hablar-imperfect"], { hint: "hablaba" }),
      conjugate("u9l5-conj-2", "comer", "nosotros/as", "Past (ongoing)", ["comíamos", "comiamos", "Comíamos"], "nosotros + comer → comíamos.", ["comer-imperfect"], { hint: "comíamos" }),
    ],
  },
  "u9-l6": {
    ...
    exercises: [
      ...
      conjugate("u9l6-3", "tener", "yo", "Past (ongoing)", ["tenía", "tenia", "Tenía"], "yo + tener → tenía.", ["tener-imperfect"], { hint: "tenía" }),
      conjugate("u9l6-4", "tener", "ustedes", "Past (ongoing)", ["tenían", "tenian", "Tenían"], "ustedes + tener → tenían.", ["tener-imperfect"], { hint: "tenían" }),
      conjugate("u9l6-5", "ir", "yo", "Past (ongoing)", ["iba", "Iba"], "yo + ir → iba.", ["ir-imperfect"], { hint: "iba" }),
      conjugate("u9l6-6", "ir", "nosotros/as", "Past (ongoing)", ["íbamos", "ibamos", "Íbamos"], "nosotros + ir → íbamos.", ["ir-imperfect"], { hint: "íbamos" }),
      conjugate("u9l6-7", "hablar", "tú", "Past (ongoing)", ["hablabas", "Hablabas"], "tú + hablar → hablabas.", ["hablar-imperfect"], { hint: "hablabas" }),
      conjugate("u9l6-8", "comer", "él/ella/usted", "Past (ongoing)", ["comía", "comia", "Comía"], "él/ella/usted + comer → comía.", ["comer-imperfect"], { hint: "comía" }),
  ...
  "u9-l11": {
    ...
    exercises: [
      ...
      conjugate("u9l11-conj-1", "tener", "yo", "Past (ongoing)", ["tenía", "tenia", "Tenía"], "yo tenía… for past possession.", ["tener-imperfect"], { hint: "tenía" }),
    ],
  },
  "u9-l12": {
    ...
    exercises: [
      ...
      conjugate("u9l12-conj-1", "ser", "nosotros/as", "Past (ongoing)", ["éramos", "eramos", "Éramos"], "nosotros + ser → éramos.", ["ser-imperfect"], { hint: "éramos" }),
      conjugate("u9l12-conj-2", "comer", "yo", "Past (ongoing)", ["comía", "comia", "Comía"], "yo + comer → comía.", ["comer-imperfect"], { hint: "comía" }),
