...
export const UNIT9_LESSONS: Record<string, Lesson> = {
  ...
  "u9-l4": {
    ...
    exercises: [
      ...
      { id: "u9l4-1", type: "select", prompt: "The past (ongoing) is great for…", options: ["Habits and descriptions in the past", "Only future plans", "Only ordering juice", "Only saying hello"], correctIndex: 0, explanation: "Used to… / was …ing / was (background).", wordCardIds: ["imperfecto"], xp: 3 },
      teach("teach-u9l4-ser", "ser-imperfect"),
      { id: "u9l4-2", type: "select", prompt: "‘When I was a kid…’ uses past (ongoing) ser:", options: ["Cuando era niño…", "Cuando fui niño siempre", "Cuando soy niño", "Cuando comí niño"], correctIndex: 0, explanation: "Cuando era niño… — background identity.", wordCardIds: ["ser-imperfect", "cuando-era"], xp: 3 },
  ...
  "u9-l11": {
    ...
    exercises: [
      ...
      listen("u9l11-8", "Tengo una reserva a nombre de Ana.", ["I have a reservation under Ana's name.", "I used to have Ana's passport.", "I disagree with Ana.", "Where is Ana's past (ongoing)?"], 0, "Tengo una reserva a nombre de Ana.", ["reserva"]),
  ...
  "u9-l12": {
    ...
    exercises: [
      ...
      { id: "u9l12-2", type: "select", prompt: "yo + ir past (ongoing) =", options: ["iba", "fui", "voy ayer", "iré"], correctIndex: 0, explanation: "iba.", wordCardIds: ["ir-imperfect"], xp: 3 },
