...
export const UNIT10_LESSONS: Record<string, Lesson> = {
  "u10-l1": {
    ...
    exercises: [
      ...
      { id: "u10l1-1", type: "select", prompt: "‘I have a meeting at ten’ is…", options: ["Tengo una reunión a las diez.", "Tengo un resfriado a las diez.", "Me duele una reunión.", "Iré un proyecto."], correctIndex: 0, hint: "You need tener + reunión — not resfriado (a cold), doler, or a future tense.", explanation: "Tengo una reunión a las diez.", wordCardIds: ["reunion", "a-las"], xp: 3 },
      ...
      { id: "u10l1-3", type: "translate", prompt: "Translate: ‘My colleague works from home.’", acceptedAnswers: ["Mi colega trabaja desde casa.", "Mi colega trabaja desde casa"], hint: "Mi + the coworker word (same form for m/f, ends in -a) + the él/ella form of trabajar + the ‘from’ preposition (desde, not de) + the home word.", explanation: "Mi colega trabaja desde casa.", wordCardIds: ["colega", "desde-casa"], xp: 4 },
      teach("teach-u10l1-uni", "universidad"),
      listen("u10l1-4", "¿A qué hora es la reunión?", ["What time is the meeting?", "Where is the pharmacy?", "Do you have a fever?", "Will you travel?"], 0, "¿A qué hora es la reunión?", ["reunion"], 3, "A qué hora es la reunión asks about timing — not a location, a fever, or travel."),
      { id: "u10l1-5", type: "fill-blank", prompt: "Type the missing Spanish.", englishPrompt: "I study at the university.", template: "Estudio en la ___.", acceptedAnswers: ["universidad", "Universidad"], hint: "Where you study for a degree — a cognate, feminine, ends in -dad.", explanation: "Estudio en la universidad.", wordCardIds: ["universidad", "estudiar"], xp: 3 },
      ...
      conjugate("u10l1-conj-1", "trabajar", "yo", "Present indicative", ["trabajo", "Trabajo"], "yo + trabajar → trabajo.", ["trabajar"]),
    ],
  },
  "u10-l2": {
    ...
    exercises: [
      ...
      { id: "u10l2-1", type: "select", prompt: "Ask: ‘What major are you studying?’", options: ["¿Qué carrera estudias?", "¿Qué fiebre estudias?", "¿Qué farmacia comes?", "¿Qué dolor trabajas?"], correctIndex: 0, hint: "Asking about a major uses carrera, not fiebre, farmacia, or dolor.", explanation: "¿Qué carrera estudias?", wordCardIds: ["carrera", "estudiar"], xp: 3 },
      ...
      { id: "u10l2-3", type: "fill-blank", prompt: "Type the missing Spanish.", englishPrompt: "I'll send you an email today.", template: "Te envío un ___ hoy.", acceptedAnswers: ["correo", "Correo"], hint: "The word for mail (post or electronic) — related to ‘courier’, masculine.", explanation: "Te envío un correo hoy.", wordCardIds: ["correo", "hoy"], xp: 3 },
  ...
  "u10-l3": {
    ...
    exercises: [
      ...
      { id: "u10l3-1", type: "select", prompt: "‘I would like to finish the project soon’ starts with…", options: ["Me gustaría…", "Me duele…", "Tengo fiebre…", "La farmacia…"], correctIndex: 0, hint: "The polite wish starts with me gustaría, not doler, tener fiebre, or farmacia.", explanation: "Me gustaría terminar el proyecto pronto.", wordCardIds: ["me-gustaria", "proyecto"], xp: 3 },
      ...
      { id: "u10l3-3", type: "fill-blank", prompt: "Type the missing Spanish.", englishPrompt: "You should talk with your colleague.", template: "___ hablar con tu colega.", acceptedAnswers: ["Deberías", "Deberias", "deberías", "deberias"], hint: "Soft advice: the conditional of deber (‘should’), tú form — ends in -ías.", explanation: "Deberías hablar con tu colega.", wordCardIds: ["deberia", "colega"], xp: 3 },
      listen("u10l3-4", "Me gustaría trabajar desde casa.", ["I would like to work from home.", "I have a cold at home.", "My head hurts at home.", "I booked the pharmacy."], 0, "Me gustaría trabajar desde casa.", ["me-gustaria", "desde-casa"], 3, "Me gustaría trabajar is 'I would like to work' — not a cold, a headache, or a booking."),
      { id: "u10l3-5", type: "situational-choose", prompt: "Pick the soft advice.", situation: "A friend looks tired after work.", options: ["Deberías descansar.", "Debes comer el proyecto.", "Me duele tu colega.", "Iré la fiebre."], correctIndex: 0, hint: "Soft advice uses deberías + infinitive, not deber with the wrong verb or unrelated lines.", explanation: "Deberías descansar.", wordCardIds: ["deberia", "descansar"], xp: 3 },
      ...
      { id: "u10l3-7", type: "translate", prompt: "Translate: ‘I would like to go to the meeting.’", acceptedAnswers: ["Me gustaría ir a la reunión.", "Me gustaria ir a la reunion.", "Me gustaría ir a la reunion."], hint: "Me + the conditional of gustar + the infinitive of ir + a la + the meeting word (a cognate of ‘reunion’).", explanation: "Me gustaría ir a la reunión.", wordCardIds: ["me-gustaria", "reunion"], xp: 4 },
      { id: "u10l3-8", type: "select", prompt: "Reuse: ‘Sounds good to me’ is…", options: ["Me parece bien.", "Me duele bien.", "Tengo fiebre bien.", "Desde casa bien."], correctIndex: 0, hint: "A Unit 8/9 reuse — me parece bien, not doler, tener fiebre, or desde casa.", explanation: "Me parece bien — from Unit 8/9.", wordCardIds: ["me-parece"], xp: 2 },
    ],
  },
  "u10-l4": {
    ...
    exercises: [
      ...
      { id: "u10l4-1", type: "select", prompt: "‘I'm going to send an email tomorrow’ is…", options: ["Voy a enviar un correo mañana.", "Fui a enviar un correo ayer solo.", "Me duele enviar un correo.", "Tengo fiebre el correo."], correctIndex: 0, hint: "Near future is voy a + infinitive, not the past fui, doler, or tener fiebre.", explanation: "Voy a enviar un correo mañana.", wordCardIds: ["ir-a-deep", "correo", "manana"], xp: 3 },
      ...
      { id: "u10l4-3", type: "fill-blank", prompt: "Type the missing Spanish.", englishPrompt: "Next month I start a new project.", template: "El próximo ___ empiezo un proyecto nuevo.", acceptedAnswers: ["mes", "Mes"], hint: "El próximo ___: the unit of time between a week and a year — three letters.", explanation: "El próximo mes empiezo un proyecto nuevo.", wordCardIds: ["el-proximo-mes", "proyecto"], xp: 3 },
      listen("u10l4-4", "¿Vas a ir a la reunión?", ["Are you going to go to the meeting?", "Do you have a fever?", "Where is the pharmacy?", "Will you take medicine?"], 0, "¿Vas a ir a la reunión?", ["ir-a-deep", "reunion"], 3, "¿Vas a ir…? asks about a future plan — not a fever, a pharmacy, or medicine."),
      { id: "u10l4-5", type: "situational-choose", prompt: "Pick the best line.", situation: "Someone asks your plan for next week.", options: ["Voy a trabajar desde casa la próxima semana.", "Tuve fiebre la próxima semana.", "Me duele el próximo mes.", "Comí la reunión."], correctIndex: 0, hint: "A future work plan uses voy a + infinitive, not tuve (past), doler, or comer.", explanation: "Voy a trabajar desde casa la próxima semana.", wordCardIds: ["ir-a-deep", "desde-casa", "la-proxima-semana"], xp: 3 },
      ...
      { id: "u10l4-7", type: "translate", prompt: "Translate: ‘Are you going to study next week?’", acceptedAnswers: ["¿Vas a estudiar la próxima semana?", "Vas a estudiar la próxima semana?", "¿Vas a estudiar la proxima semana?"], hint: "Near future: the tú form of ir + a + the infinitive of estudiar + la + the ‘next week’ phrase (próxima before semana).", explanation: "¿Vas a estudiar la próxima semana?", wordCardIds: ["ir-a-deep", "estudiar", "la-proxima-semana"], xp: 4 },
      conjugate("u10l4-conj-1", "ir", "nosotros/as", "Present indicative", ["vamos", "Vamos"], "nosotros + ir → vamos (as in vamos a…).", ["ir-a-deep", "ir"]),
    ],
  },
  "u10-l5": {
    ...
    exercises: [
      ...
      { id: "u10l5-1", type: "select", prompt: "The simple future is great for…", options: ["Will / shall plans and predictions", "Only past habits", "Only ordering juice", "Only greetings"], correctIndex: 0, hint: "The simple future is for will/shall, not past habits, ordering, or greetings.", explanation: "hablaré / trabajaré — will forms.", wordCardIds: ["futuro-simple"], xp: 3 },
      teach("teach-u10l5-hablar", "hablar-future"),
      { id: "u10l5-2", type: "select", prompt: "yo + hablar (future) is…", options: ["hablaré", "hablaba", "hablé", "hablo ayer"], correctIndex: 0, hint: "Regular -ar future yo ending is -é added to the infinitive — not the imperfect, preterite, or a garbled present.", explanation: "hablaré.", wordCardIds: ["hablar-future"], xp: 3 },
      ...
      listen("u10l5-5", "Tendré una reunión a las once.", ["I will have a meeting at eleven.", "I had a fever at eleven.", "I booked the pharmacy.", "I used to work at eleven."], 0, "Tendré una reunión a las once.", ["tener-future", "reunion", "a-las"], 3, "Tendré is the future 'I will have' — not the past, a booking, or the imperfect."),
      ...
      { id: "u10l5-7", type: "situational-choose", prompt: "Pick the best line.", situation: "Promise a coworker you will email them.", options: ["Te enviaré un correo mañana.", "Te envié un resfriado.", "Me duele el correo ayer.", "Íbamos la farmacia."], correctIndex: 0, hint: "A promise uses the future enviaré, not the past envié, doler, or the imperfect.", explanation: "Te enviaré un correo mañana.", wordCardIds: ["correo", "manana"], xp: 3 },
    ],
  },
  "u10-l6": {
    ...
    exercises: [
      conjugate("u10l6-1", "hablar", "yo", "Simple future", ["hablaré", "hablare", "Hablaré"], "yo + hablar → hablaré.", ["hablar-future"]),
      conjugate("u10l6-2", "hablar", "tú", "Simple future", ["hablarás", "hablaras", "Hablarás"], "tú + hablar → hablarás.", ["hablar-future"]),
      conjugate("u10l6-3", "trabajar", "yo", "Simple future", ["trabajaré", "trabajare", "Trabajaré"], "yo + trabajar → trabajaré.", ["trabajar-future"]),
      conjugate("u10l6-4", "trabajar", "ustedes", "Simple future", ["trabajarán", "trabajaran", "Trabajarán"], "ustedes + trabajar → trabajarán.", ["trabajar-future"]),
      conjugate("u10l6-5", "ir", "yo", "Simple future", ["iré", "ire", "Iré"], "yo + ir → iré.", ["ir-future"]),
      conjugate("u10l6-6", "ir", "nosotros/as", "Simple future", ["iremos", "Iremos"], "nosotros + ir → iremos.", ["ir-future"]),
      conjugate("u10l6-7", "tener", "yo", "Simple future", ["tendré", "tendre", "Tendré"], "yo + tener → tendré.", ["tener-future"]),
      conjugate("u10l6-8", "tener", "tú", "Simple future", ["tendrás", "tendras", "Tendrás"], "tú + tener → tendrás.", ["tener-future"]),
      { id: "u10l6-9", type: "fill-blank", prompt: "Type the missing Spanish.", englishPrompt: "You will have time tomorrow.", template: "Tú ___ tiempo mañana.", acceptedAnswers: ["tendrás", "tendras", "Tendrás"], hint: "tener future", explanation: "Tú tendrás tiempo mañana.", wordCardIds: ["tener-future", "manana"], xp: 3 },
      listen("u10l6-10", "Hablaré con mi colega mañana.", ["I will talk with my colleague tomorrow.", "I had a cold tomorrow.", "I booked the pharmacy.", "I used to eat tomorrow."], 0, "Hablaré con mi colega mañana.", ["hablar-future", "colega", "manana"], 3, "Hablaré is the future 'I will talk' — not a cold, a booking, or a past-tense verb."),
  ...
  "u10-l7": {
    ...
    exercises: [
      ...
      { id: "u10l7-1", type: "select", prompt: "‘My head hurts’ is…", options: ["Me duele la cabeza.", "Mi cabeza duele yo.", "Tengo reunión la cabeza.", "Iré la cabeza."], correctIndex: 0, hint: "Doler works like gustar: me duele + the body part — not mi cabeza duele yo or unrelated phrases.", explanation: "Me duele la cabeza.", wordCardIds: ["me-duele", "dolor"], xp: 3 },
      ...
      { id: "u10l7-3", type: "fill-blank", prompt: "Type the missing Spanish.", englishPrompt: "I have a fever and my head hurts.", template: "Tengo ___ y me duele la cabeza.", acceptedAnswers: ["fiebre", "Fiebre"], hint: "The symptom that comes with a temperature — feminine, a cognate of ‘febrile’.", explanation: "Tengo fiebre y me duele la cabeza.", wordCardIds: ["fiebre", "me-duele"], xp: 3 },
      teach("teach-u10l7-resfriado", "resfriado"),
      listen("u10l7-4", "Tengo un resfriado.", ["I have a cold.", "I have a meeting.", "I will travel.", "I work from home."], 0, "Tengo un resfriado.", ["resfriado"], 3, "Tengo un resfriado is 'I have a cold' — not a meeting, travel, or remote work."),
      teach("teach-u10l7-dolor", "dolor"),
      { id: "u10l7-5", type: "situational-choose", prompt: "Pick the best reply.", situation: "A friend asks ¿Cómo estás? and you feel unwell.", options: ["Hoy no estoy bien.", "Hoy tengo una carrera de jugo.", "Hoy voy a la reunión de farmacia solo para saludar.", "Hoy hablaba el imperfecto."], correctIndex: 0, hint: "Saying you feel unwell uses no estoy bien, not unrelated nouns or the imperfect.", explanation: "Hoy no estoy bien.", wordCardIds: ["estoy-bien"], xp: 3 },
      ...
      { id: "u10l7-7", type: "translate", prompt: "Translate: ‘I have a headache.’", acceptedAnswers: ["Tengo dolor de cabeza.", "Me duele la cabeza.", "Tengo un dolor de cabeza."], hint: "Two ways: the yo form of tener + dolor de + the head word, or me + the él/ella form of doler + la + the head word.", explanation: "Tengo dolor de cabeza / Me duele la cabeza.", wordCardIds: ["dolor", "me-duele"], xp: 4 },
    ],
  },
  "u10-l8": {
    ...
    exercises: [
      ...
      { id: "u10l8-1", type: "select", prompt: "‘I have an appointment at three’ is…", options: ["Tengo una cita a las tres.", "Tengo un colega a las tres solo.", "Me duele una cita.", "Voy a la universidad de fiebre."], correctIndex: 0, hint: "An appointment uses cita, not colega, doler, or universidad.", explanation: "Tengo una cita a las tres.", wordCardIds: ["cita", "a-las"], xp: 3 },
      ...
      { id: "u10l8-3", type: "fill-blank", prompt: "Type the missing Spanish.", englishPrompt: "I'm going to the pharmacy for the medicine.", template: "Voy a la ___ por la medicina.", acceptedAnswers: ["farmacia", "Farmacia"], hint: "Where you buy medicine — a cognate of ‘pharmacy’ with an f, feminine.", explanation: "Voy a la farmacia por la medicina.", wordCardIds: ["farmacia", "medicina"], xp: 3 },
      listen("u10l8-4", "Quiero hacer una cita.", ["I want to make an appointment.", "I want to eat a project.", "I will work from fever.", "I booked a flight only."], 0, "Quiero hacer una cita.", ["cita"], 3, "Quiero hacer una cita is 'I want to make an appointment' — not eating, working, or booking a flight."),
      { id: "u10l8-5", type: "situational-choose", prompt: "Pick the soft advice.", situation: "A coworker has a bad cold.", options: ["Deberías ir al médico.", "Deberías enviar la fiebre al aeropuerto.", "Deberías comer el proyecto.", "Íbamos la entrevista."], correctIndex: 0, hint: "Soft advice for illness uses deberías ir al médico, not unrelated verbs or nouns.", explanation: "Deberías ir al médico.", wordCardIds: ["deberia", "medico"], xp: 3 },
      ...
      { id: "u10l8-7", type: "translate", prompt: "Translate: ‘You should take the medicine.’", acceptedAnswers: ["Deberías tomar la medicina.", "Deberias tomar la medicina.", "Debes tomar la medicina."], hint: "Soft advice: the tú conditional of deber (-ías) + the infinitive of tomar + la + the medicine word (a cognate).", explanation: "Deberías tomar la medicina.", wordCardIds: ["deberia", "medicina"], xp: 4 },
      listen("u10l8-8", "La farmacia está cerca.", ["The pharmacy is nearby.", "The meeting is nearby.", "I have a fever nearby.", "I will work nearby."], 0, "La farmacia está cerca.", ["farmacia", "cerca"], 3, "La farmacia está cerca — not a meeting, a fever, or work."),
      dlg("dlg-u10-appt"),
    ],
  },
  "u10-l9": {
  ...
  "u10-l10": {
    ...
    exercises: [
      dictation("u10l10-dict-1", "Mañana voy a trabajar desde casa.", ["Mañana voy a trabajar desde casa.", "Manana voy a trabajar desde casa."], "Type the line you heard.", ["manana", "ir-a-deep", "desde-casa"], { hint: "Mañana opens it, then the near-future plan and where you'll be working.", voice: "f" }),
      ...
      dictation("u10l10-dict-2", "Tendré una reunión por la mañana.", ["Tendré una reunión por la mañana.", "Tendre una reunion por la mañana.", "Tendré una reunion por la mañana."], "Type the line you heard.", ["tener-future", "reunion"], { hint: "The future tener form, then what's scheduled and when.", voice: "m" }),
      ...
      dictation("u10l10-dict-3", "Hoy no estoy bien — me duele la cabeza.", ["Hoy no estoy bien — me duele la cabeza.", "Hoy no estoy bien, me duele la cabeza.", "Hoy no estoy bien - me duele la cabeza."], "Type the line you heard.", ["estoy-bien", "me-duele"], { hint: "Feeling unwell first, then doler plus the body part that hurts.", voice: "c" }),
      ...
      dictation("u10l10-dict-4", "Mi colega dice: deberías ir a la farmacia.", ["Mi colega dice: deberías ir a la farmacia.", "Mi colega dice: deberias ir a la farmacia."], "Type the line you heard.", ["colega", "deberia", "farmacia"], { hint: "Mi colega dice ('my colleague says'), then soft advice about where to go.", voice: "f" }),
      cloze("u10l10-cloze-4", "Mi colega dice: deberías ir a la ___.", ["farmacia", "Farmacia"], "Mi colega dice: deberías ir a la farmacia.", ["deberia", "farmacia", "colega"], { hint: "Where a colleague sends you when you’re sick — a cognate of ‘pharmacy’ with an f.", audioText: "Mi colega dice: deberías ir a la farmacia.", voice: "f" }),
      dictation("u10l10-dict-5", "De acuerdo. Compraré medicina y descansaré.", ["De acuerdo. Compraré medicina y descansaré.", "De acuerdo, compraré medicina y descansaré.", "De acuerdo. Comprare medicina y descansare."], "Type the line you heard.", ["de-acuerdo", "medicina", "descansar"], { hint: "Agreement first, then two future-tense actions joined by y.", voice: "m" }),
      cloze("u10l10-cloze-5", "De acuerdo. Compraré ___ y descansaré.", ["medicina", "Medicina"], "De acuerdo. Compraré medicina y descansaré.", ["medicina", "descansar"], { hint: "What you buy at the farmacia — a cognate, feminine.", audioText: "De acuerdo. Compraré medicina y descansaré.", voice: "m" }),
    ],
  },
  "u10-l11": {
    ...
    exercises: [
      { id: "u10l11-1", type: "situational-choose", prompt: "Pick the best line.", situation: "You need to cancel a meeting because you are sick.", options: ["No puedo ir a la reunión — estoy enfermo.", "No puedo ir a la reunión — soy metro.", "No puedo ir — comí el imperfecto.", "No puedo ir — el pasaporte tiene fiebre."], correctIndex: 0, hint: "Canceling due to illness uses estoy enfermo, not ser, comer, or a fever on a passport.", explanation: "No puedo ir a la reunión — estoy enfermo.", wordCardIds: ["reunion", "enfermo"], xp: 4 },
      { id: "u10l11-2", type: "situational-choose", prompt: "Pick the best line.", situation: "A coworker asks about next week's plan.", options: ["Voy a terminar el proyecto la próxima semana.", "Voy a terminar el resfriado ayer.", "Íbamos el proyecto de jugo.", "Me duele la próxima semana el correo."], correctIndex: 0, hint: "A future plan uses voy a + infinitive with la próxima semana, not the past ayer or doler.", explanation: "Voy a terminar el proyecto la próxima semana.", wordCardIds: ["ir-a-deep", "proyecto", "la-proxima-semana"], xp: 3 },
      ...
      listen("u10l11-4", "¿Tienes una cita con el médico?", ["Do you have an appointment with the doctor?", "Do you have a project with juice?", "Will you fly tomorrow only?", "Did you eat the pharmacy?"], 0, "¿Tienes una cita con el médico?", ["cita", "medico"], 3, "¿Tienes una cita…? asks about an appointment — not a project, travel, or eating."),
      { id: "u10l11-5", type: "translate", prompt: "Translate: ‘I will talk with my colleague tomorrow.’", acceptedAnswers: ["Hablaré con mi colega mañana.", "Hablare con mi colega mañana.", "Voy a hablar con mi colega mañana."], hint: "Simple future: hablar + the yo ending -é (ir a + infinitive works too), then con mi + the coworker word + ‘tomorrow’.", explanation: "Hablaré con mi colega mañana.", wordCardIds: ["hablar-future", "colega", "manana"], xp: 4 },
      { id: "u10l11-6", type: "fill-blank", prompt: "Type the missing Spanish.", englishPrompt: "Next month I will travel.", template: "El próximo mes ___.", acceptedAnswers: ["viajaré", "viajaré.", "viajare", "Viajaré"], hint: "Simple future of viajar (a cognate of ‘voyage’): the whole infinitive + the yo ending -é.", explanation: "El próximo mes viajaré.", wordCardIds: ["el-proximo-mes", "futuro-simple"], xp: 3 },
      { id: "u10l11-7", type: "select", prompt: "Friend has a fever. Soft advice?", options: ["Deberías ir al médico y descansar.", "Nunca hables.", "Come el proyecto.", "Íbamos no forever."], correctIndex: 0, hint: "Soft advice pairs deberías with two real suggestions, not a harsh command or garbled line.", explanation: "Advice + rest.", wordCardIds: ["deberia", "medico", "descansar"], xp: 3 },
      listen("u10l11-8", "Te envío un correo hoy.", ["I'll send you an email today.", "I have a cold today.", "I booked the hotel.", "Where is the passport?"], 0, "Te envío un correo hoy.", ["correo", "hoy"], 3, "Te envío is 'I'll send you' — not a cold, a hotel, or a passport."),
      ...
      conjugate("u10l11-conj-1", "tener", "yo", "Simple future", ["tendré", "tendre", "Tendré"], "yo tendré… for future meetings.", ["tener-future"]),
    ],
  },
  "u10-l12": {
    ...
    exercises: [
      { id: "u10l12-1", type: "select", prompt: "‘I have a meeting’ is…", options: ["Tengo una reunión.", "Tengo una fiebre de metro.", "Me duele una carrera.", "Iré un jugo."], correctIndex: 0, hint: "Tener + reunión — not a fever, doler, or the future iré.", explanation: "Tengo una reunión.", wordCardIds: ["reunion"], xp: 3 },
      { id: "u10l12-2", type: "select", prompt: "yo + ir future =", options: ["iré", "iba", "fui", "voy ayer"], correctIndex: 0, hint: "Ir's future yo form is iré, not the imperfect iba, the preterite fui, or the present voy.", explanation: "iré.", wordCardIds: ["ir-future"], xp: 3 },
      ...
      { id: "u10l12-4", type: "translate", prompt: "Translate: ‘My head hurts.’", acceptedAnswers: ["Me duele la cabeza.", "Me duele la cabeza", "Tengo dolor de cabeza."], hint: "Doler works like gustar: me + the él/ella form of doler + la + the head word. (Tener dolor de… is accepted too.)", explanation: "Me duele la cabeza.", wordCardIds: ["me-duele"], xp: 4 },
      listen("u10l12-5", "Voy a terminar el proyecto la próxima semana.", ["I'm going to finish the project next week.", "I had a cold next week.", "I booked the pharmacy.", "I used to speak next week."], 0, "Voy a terminar el proyecto la próxima semana.", ["ir-a-deep", "proyecto", "la-proxima-semana"], 3, "Voy a terminar is 'I'm going to finish' — not a past-tense cold or booking."),
      { id: "u10l12-6", type: "fill-blank", prompt: "Type the missing Spanish.", englishPrompt: "I want to make an appointment.", template: "Quiero hacer una ___.", acceptedAnswers: ["cita", "Cita"], hint: "What you make with a doctor — a short feminine word that also means ‘date’.", explanation: "Quiero hacer una cita.", wordCardIds: ["cita"], xp: 3 },
      ...
      { id: "u10l12-8", type: "situational-choose", prompt: "Pick the best line.", situation: "You need medicine after work.", options: ["Voy a la farmacia por la medicina.", "Voy a la farmacia por el imperfecto.", "Voy a comer el pasaporte.", "No estoy de acuerdo el metro."], correctIndex: 0, hint: "Getting medicine uses voy a la farmacia, not comer, de acuerdo, or unrelated nouns.", explanation: "Voy a la farmacia por la medicina.", wordCardIds: ["farmacia", "medicina"], xp: 3 },
      { id: "u10l12-9", type: "select", prompt: "‘Next month’ is…", options: ["el próximo mes", "el resfriado mes", "la fiebre mes", "el colega mes"], correctIndex: 0, hint: "Not a cold, a fever, or a colleague — it's the time phrase for 'next month'.", explanation: "el próximo mes.", wordCardIds: ["el-proximo-mes"], xp: 3 },
      conjugate("u10l12-conj-1", "trabajar", "yo", "Simple future", ["trabajaré", "trabajare", "Trabajaré"], "yo + trabajar → trabajaré.", ["trabajar-future"]),
      conjugate("u10l12-conj-2", "hablar", "nosotros/as", "Simple future", ["hablaremos", "Hablaremos"], "nosotros + hablar → hablaremos.", ["hablar-future"]),
      { id: "u10l12-10", type: "fill-blank", prompt: "Type the missing Spanish.", englishPrompt: "I should rest today.", template: "___ descansar hoy.", acceptedAnswers: ["Debería", "Deberia", "debería", "deberia"], hint: "Soft advice about yourself: the conditional of deber, yo form — ends in -ía.", explanation: "Debería descansar hoy.", wordCardIds: ["deberia", "descansar"], xp: 3 },
    ],
  },
};
