...
export const UNIT10_LESSONS: Record<string, Lesson> = {
  ...
  "u10-l4": {
    ...
    exercises: [
      ...
      { id: "u10l4-7", type: "translate", prompt: "Translate: ‘Are you going to study next week?’", acceptedAnswers: ["¿Vas a estudiar la próxima semana?", "Vas a estudiar la próxima semana?", "¿Vas a estudiar la proxima semana?"], hint: "Vas a estudiar…", explanation: "¿Vas a estudiar la próxima semana?", wordCardIds: ["ir-a-deep", "estudiar", "la-proxima-semana"], xp: 4 },
  ...
  "u10-l8": {
    ...
    exercises: [
      ...
      { id: "u10l8-7", type: "translate", prompt: "Translate: ‘You should take the medicine.’", acceptedAnswers: ["Deberías tomar la medicina.", "Deberias tomar la medicina.", "Debes tomar la medicina."], hint: "Deberías tomar…", explanation: "Deberías tomar la medicina.", wordCardIds: ["deberia", "medicina"], xp: 4 },
