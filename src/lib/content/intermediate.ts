...
import { UNIT6_LESSONS, UNIT6_WORD_CARDS } from "./unit6";
...
export const INTERMEDIATE_UNITS_META = [
  ...
  },
  {
    ...
    description: "Directions, places, transport + story listening — ~12 lessons.",
    lessonIds: ["u6-l1", "u6-l2", "u6-l3", "u6-l4", "u6-l5", "u6-l6", "u6-l7", "u6-l8", "u6-l9", "u6-l10", "u6-l11", "u6-l12"],
    unlocked: true,
    track: "intermediate" as const,
  },
  {
