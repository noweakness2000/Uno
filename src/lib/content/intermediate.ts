/**
 * Intermediate track (Units 4–11) — strong A2 / early–mid B1 Spanish.
...
import { UNIT11_LESSONS, UNIT11_WORD_CARDS } from "./unit11";
  ...
  "u4-l1": {
    ...
    exercises: [
      ...
      teach("teach-u4l1-todos-los-dias", "todos-los-dias"),
      {
        ...
        hint: "The yo form of trabajar (no pronoun needed) + the ‘every day’ phrase — literally ‘all the days’, three words, plural.",
  ...
  "u4-l2": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "The yo form of vivir + en + un + the LatAm apartment word (Spain says piso; LatAm uses a cognate of ‘department’).",
      ...
      },
      {
        ...
        hint: "The LatAm word for a flat — a cognate of ‘department’, masculine.",
        explanation: "Vivo en un departamento.",
        wordCardIds: ["departamento"],
        xp: 3,
      },
  ...
  "u4-l3": {
    ...
    exercises: [
      ...
      teach("teach-u4l3-desayunar", "desayunar"),
      {
        ...
        hint: "Breakfast is a single verb in Spanish — use its yo form — then the ‘early’ adverb. Two words.",
  ...
  "u4-l4": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "The yo form of ir + a la + the office word, then en + the LatAm car word (not coche).",
      ...
      },
      {
        ...
        hint: "The workplace noun — a cognate of ‘office’, feminine (la).",
  ...
  "u4-l5": {
    ...
    exercises: [
      ...
      teach("teach-u4l5-lavar", "lavar"),
      {
        ...
        hint: "The yo form of lavar + the plural article + the dishes word (the same word as ‘plates’).",
  ...
  "u4-l6": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "The yo form of descansar + en + the home word. No subject pronoun.",
  ...
  "u4-l7": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "‘Every day’ is literally ‘all the days’ (three words). Put the yo form of trabajar in front of it.",
        explanation: "Trabajo todos los días.",
        wordCardIds: ["trabajar", "todos-los-dias"],
        xp: 4,
      },
      ...
      },
      {
        ...
        hint: "The language this course teaches — lowercase, with an ñ.",
    ...
    exercises: [
      storyListen(
        ...
        [
          ...
          {
            prompt: "What does the speaker do after getting up?",
          ...
          {
            prompt: "Where does the speaker have breakfast?",
            options: ["In the speaker's apartment", "At the office", "In the car", "At school"],
            correctIndex: 0,
            explanation: "Desayuno café en mi departamento.",
          },
          {
            prompt: "How does the speaker get to the office?",
            options: ["On foot", "They never go", "They fly", "They stay home"],
            correctIndex: 0,
    ...
    exercises: [
      {
        ...
        hint: "Levantarse is reflexive: the ‘myself’ pronoun + its yo form, then the ‘early’ adverb.",
      ...
      ),
      {
        ...
        acceptedAnswers: ["departamento", "Departamento"],
        hint: "Where you live if not in a house — the LatAm word, a cognate of ‘department’.",
      ...
      },
      {
        ...
        hint: "The yo form of limpiar + the feminine article + the kitchen word (a cognate of ‘cuisine’).",
        explanation: "Limpio la cocina.",
        wordCardIds: ["limpiar", "cocina"],
        xp: 4,
      },
    ...
    exercises: [
      storyListen(
        ...
        [
          ...
          {
            prompt: "What chores does the speaker mention?",
            options: [
          ...
          {
            prompt: "Where does the speaker rest in the afternoon?",
            options: ["In the speaker's apartment", "At the office", "On the bus", "At school"],
            correctIndex: 0,
      ...
      cloze(
        ...
        {
          hint: "The place you don’t go on weekends — a cognate of ‘office’.",
  ...
  "u4-l11": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "The yo form of estudiar + ‘all the days’ (three words).",
  ...
  "u4-l12": {
    ...
    exercises: [
      ...
      },
      {
        ...
        hint: "Start with the weekend phrase (el + fin + de + semana), then the yo form of descansar.",
        explanation: "El fin de semana descanso.",
        wordCardIds: ["fin-de-semana", "descansar"],
        xp: 4,
      },
      ...
      ),
      {
        ...
        hint: "The LatAm word for a car (Spain says coche) — starts with c, double r.",
      ...
      },
      {
        ...
        correctIndex: 0,
        hint: "All four start with por — pick the one where por is paired with a time-of-day word, not an object or ‘the end’.",
...
export const INTERMEDIATE_UNITS_META = [
  ...
  },
  {
    ...
    description: "ir a, quiero/me gustaría, invites, soft no + story listening — ~12 lessons.",
    lessonIds: ["u8-l1", "u8-l2", "u8-l3", "u8-l4", "u8-l5", "u8-l6", "u8-l7", "u8-l8", "u8-l9", "u8-l10", "u8-l11", "u8-l12"],
    unlocked: true,
    track: "intermediate" as const,
  },
  {
